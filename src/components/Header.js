  ...
  return (
    <div className="flex justify-between items-center px-4">
      <div className="left-header items-center flex pt-2">
        ...
        <BsPlus className="mx-1 cursor-pointer " size={22} />
      </div>
      <div className="right-side flex space-x-4">
        <div className="bg-gray-700 text-gray-100 p-1 px-2 font-semibold text-xs rounded-sm shadow-md cursor-pointer">
          You are on a free trial
        </div>
        <VscBellDot className="text-gray-600 cursor-pointer" size={24} />
        <BsQuestionCircle className="text-gray-600 cursor-pointer" size={24} />
        <span className="line w-1 h-6 border-r border-gray-500 "></span>
        <CgProfile className="text-gray-600 cursor-pointer" size={24} />
      </div>
    </div>
  );
}
